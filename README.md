...
### Currently: 
I've been busy with school and being a SWE intern, but I've finished a decent physics solver that can handle around 1,750 dynamic rectangular objects in a scene. I'm moving to spatial partitioning soon to improve performance after taking care of a few QOL features around the engine to clean up the code and help me iterate faster.
